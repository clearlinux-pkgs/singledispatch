...
Source0  : https://files.pythonhosted.org/packages/3a/a7/a5af00d31a7f9f872f2bffa7f4c2e33a24ef76ac8218aadb974a5191014b/singledispatch-3.6.0.tar.gz
...
%prep
%setup -q -n singledispatch-3.6.0
cd %{_builddir}/singledispatch-3.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614017738
...
cp %{_builddir}/singledispatch-3.6.0/LICENSE %{buildroot}/usr/share/package-licenses/singledispatch/8e6689d37f82d5617b7f7f7232c94024d41066d1
